...
const variantStyles: Record<Variant, string> = {
  ...
  primary:
    'bg-[linear-gradient(135deg,#F6A8C4_0%,#F17CA5_30%,#E91E73_60%,#C4185E_100%)] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.35),0_18px_40px_-18px_rgba(233,30,115,0.75)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.45),0_22px_50px_-16px_rgba(233,30,115,0.9)] hover:-translate-y-0.5',
