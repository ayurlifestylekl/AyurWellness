...
import { setTicketInternalNotes } from '@/lib/admin/messages/actions'
...
export default function InternalNotesPanel({
  ...
  async function save() {
    ...
    setError(null)
    setSaved(false)
    const r = await setTicketInternalNotes(ticketId, val)
    setPending(false)
  ...
  return (
    <div className="rounded-2xl border border-[#006B3C]/8 bg-white p-4">
      ...
      <textarea
        ...
        rows={3}
        placeholder="Context for other staff: prior conversations, escalation, etc."
